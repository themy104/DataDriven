...
public class TC04VerifyCodeRequiredFieldInProductCategoriesPage extends BaseTest {
    @Test(dataProvider = "testdata", priority = 5)
    public void tc04(String url, String username, String password, String name,
